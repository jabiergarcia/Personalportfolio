...
export const InteractiveEducationTimeline: React.FC = () => {
  ...
  const lastActiveEvent = useRef<string>(educationData[0].id);
  ...
  useEffect(() => {
    ...
    const updateActiveCard = () => {
      ...
      // Calcular zona de activación: entre 35% y 65% del viewport
  ...
  const activeEventData = educationData.find(e => e.id === activeEvent);
  const activeIndex = educationData.findIndex(e => e.id === activeEvent);
          ...
          <div className="sticky top-16 z-10 bg-background/95 backdrop-blur-sm border-b border-border/50 py-5 mb-6 -mx-4 px-4">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-muted-foreground">{activeEventData?.institution}</p>
              </motion.div>
            </AnimatePresence>
            ...
            <div className="relative px-1">
              ...
              <motion.div 
                ...
                initial={false}
                animate={{ 
                  width: `${(activeIndex / (educationData.length - 1)) * 100}%` 
                }}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <GraduationCap size={isActive ? 22 : 18} strokeWidth={isActive ? 2.5 : 2} />
                        </div>
                      </motion.div>
                    </button>
                  );
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-secondary font-medium mb-2">{event.institution}</p>
                ...
                {educationData.map((event) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <GraduationCap size={isActive ? 22 : 20} className={`text-white transition-all duration-300 ${isActive ? 'drop-shadow-lg' : ''}`} />
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="text-muted-foreground line-clamp-2">{event.institution}</p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-lg text-secondary font-medium mb-3">{event.institution}</p>
